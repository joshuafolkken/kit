...
2. **Does the whole of it clearly exceed what one verification gate can confirm in one pass?** The
   guide is **about 10 changed files and about 400 changed lines** (test files excluded). Under that, it is one
   Issue however many separable pieces a reader can name inside it.
