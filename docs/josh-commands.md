...
Round trips:
  ...
  batched turns                   2   144 single-call turn(s)
...
Bundling:
  ...
  recoverable wait          3.7 min   at 8.8 s model time per round trip

Failure re-runs:
  failed calls                    3   of 148 call(s), 26 outcome unreadable
  re-run after failure       2.2 min   10.8% of tool execution

By tool (descending):
  Bash: pnpm                7.0 min   12 call(s) · 11 round trip(s) · 10 alone
  Skill                     5.7 min   4 call(s) · 4 round trip(s) · 4 alone
  Edit                      1.7 min   34 call(s) · 34 round trip(s) · 34 alone
  …
