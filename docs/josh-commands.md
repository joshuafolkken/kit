...
Investigation reads:
  edit targets                   17   89.5% · of the reads this run made
  under the threshold             1   5.3% · of the reads this run made
  refused                         0   0.0% · of the reads this run made
  let through                     1   5.3% · of the reads this run made
