...
By phase (in run order):
  ...
  wait                     28.8 min   39.4%
  pre-run                   0.0 min   0.0%
  post-run                  1.3 min   1.8%
  other                     0.0 min   0.0%

Round trips:
  tool calls                    148   over 237 turn(s)
  round trips                   146   1.01 calls per round trip
