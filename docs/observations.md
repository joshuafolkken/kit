...
- k:unit-suite-live-telegram | d1 | 2026-09-24 | scripts/test/test-network-guard.ts | A #2492 lane test drove run:carry --end --stopped with no notifier mock and sent two real Telegram stop confirmations, because the unit-suite guard shims gh and git but not fetch
- rf:bug-risks | medium | scripts/run/run-carry-cli.ts:343 | 2026-09-24 | #2492
- rf:bug-risks | medium | scripts/run/run-event-cli.ts:206 | 2026-09-24 | #2492
- rf:comments | medium | docs/josh-commands.md:1723 | 2026-09-24 | #2492
- rf:tests | medium | scripts/run/run-event-cli.ts:126 | 2026-09-24 | #2492
- rf:assumptions | low | .claude/skills/workflow-commands/backlogrun-steps.md:219 | 2026-09-24 | #2492
- rf:project-conventions | low | scripts/run/run-event-cli.ts:138 | 2026-09-24 | #2492
- rf:tests | low | scripts/run/run-event-render.test.ts:17 | 2026-09-24 | #2492
- rf:bug-risks | medium | scripts/document/edit-files-cli.ts | 2026-09-24 | #2493
- rf:bug-risks | low | scripts/document/edit-files-cli.ts | 2026-09-24 | #2493
- rf:bug-risks | medium | scripts/observations/observations-flush-landing.ts | 2026-09-24 | #2497
- rf:bug-risks | medium | scripts/git/git-pr-checks.ts | 2026-09-24 | #2497
- rf:bug-risks | low | scripts/observations/observations-flush-landing.ts | 2026-09-24 | #2497
- rf:tests | low | scripts/git/git-pr-checks.ts | 2026-09-24 | #2497
- rf:bug-risks | medium | scripts/test/test-red.ts:57 | 2026-09-23 | #2448
- rf:bug-risks | low | scripts/test/test-red.ts:42 | 2026-09-23 | #2448
- rf:bug-risks | low | scripts/test/test-red-logic.ts:24 | 2026-09-23 | #2448
- rf:tests | low | scripts-ai/git-workflow.test.ts:66 | 2026-09-23 | #2448
- rf:tests | low | vitest.harness.config.ts | 2026-09-23 | #2447
- rf:bug-risks | medium | scripts/test/test-red.ts:59 | 2026-09-23 | #2448
- rf:bug-risks | low | scripts/test/test-red-logic.ts:42 | 2026-09-23 | #2448
- rf:tests | medium | scripts/run/run-ship-detach.test.ts:83 | 2026-09-23 | #2457
- rf:bug-risks | low | scripts/run/run-ship-cli.ts:366 | 2026-09-23 | #2457
- rf:comments | low | .claude/skills/workflow-commands/chain-rule.md:8 | 2026-09-23 | #2457
- rf:project-conventions | low | scripts/run/run-ship-detach.ts:118 | 2026-09-23 | #2457
- rf:tests | low | scripts/run/run-ship-cli.test.ts:22 | 2026-09-23 | #2457
- rf:tests | low | scripts/run/run-ship-cli-detach.test.ts:93 | 2026-09-23 | #2457
- rf:bug-risks | medium | scripts/backlog/backlog-next.ts | 2026-09-23 | #2455
- rf:performance | low | scripts/backlog/backlog-defect-priority.ts | 2026-09-23 | #2455
- rf:tests | low | scripts/backlog/backlog-defect-priority.test.ts | 2026-09-23 | #2455
- rf:tests | low | scripts/run/run-ship-detach.test.ts:92 | 2026-09-23 | #2457
- rf:tests | low | scripts/run/run-ship-cli-detach.test.ts:95 | 2026-09-23 | #2457
- rf:comments | low | docs/josh-commands.md:1715 | 2026-09-23 | #2457
- k:epic-add-lost-declaration | d1 | 2026-09-24 | pnpm josh epic --add | Epic #2450 recorded the #2498 -> #2494 blocked-by relation while its body declared only #2498 -> #2497, likely two lanes running epic --add on one epic at once, which then refused every later epic --add until the body was repaired by hand
