...
- rf:comments | low | docs/josh-commands.md:147 | 2026-09-24 | #2498
- rf:project-conventions | low | vitest.pilot.config.ts:18 | 2026-09-24 | #2494
- rf:project-conventions | low | scripts/test/test-network-guard.ts:450 | 2026-09-24 | #2494
- rf:tests | low | scripts/test/test-network-guard.ts:414 | 2026-09-24 | #2494
- rf:comments | low | scripts/test/test-network-guard.test.ts:467 | 2026-09-24 | #2494
- rf:assumptions | low | vitest.harness.config.ts:12 | 2026-09-24 | #2494
- rf:bug-risks | low | scripts/run/run-ship-review-steps.ts:185 | 2026-09-24 | #2500
- rf:assumptions | low | scripts/run/run-ship-review-steps.ts:175 | 2026-09-24 | #2500
- rf:tests | low | scripts/run/run-ship-review-steps.test.ts:162 | 2026-09-24 | #2500
- rf:bug-risks | medium | scripts/git/git-pr-checks.ts:328 | 2026-09-24 | #2497
- rf:performance | low | scripts/git/git-pr-checks.ts:326 | 2026-09-24 | #2497
- rf:assumptions | low | scripts/observations/observations-flush-landing.ts:63 | 2026-09-24 | #2497
- rf:comments | low | scripts/run/run-carry-flush.ts:23 | 2026-09-24 | #2497
- rf:project-conventions | low | scripts/git/git-gh-pr-auto-merge.ts:20 | 2026-09-24 | #2497
- rf:tests | low | scripts/git/git-pr-checks-merged.test.ts | 2026-09-24 | #2497
- rf:bug-risks | medium | scripts/backlog/backlog-arrival.ts | 2026-09-24 | #2503
- rf:performance | low | scripts/backlog/backlog-arrival.ts | 2026-09-24 | #2503
- rf:tests | low | scripts/run/run-progress-wait.test.ts | 2026-09-24 | #2503
- rf:comments | low | .claude/skills/workflow-commands/backlogrun-progress.md | 2026-09-24 | #2503
- rf:bug-risks | medium | scripts/backlog/backlog-arrival.ts | 2026-09-24 | #2503
- rf:comments | low | .claude/skills/workflow-commands/backlogrun-progress.md | 2026-09-24 | #2503
- rf:bug-risks | low | scripts/observations/observations-flush-landing.ts:59 | 2026-09-24 | #2497
- rf:bug-risks | low | scripts/observations/observations-flush.ts:413 | 2026-09-24 | #2497
- rf:bug-risks | medium | scripts/backlog/backlog-drive.ts:99 | 2026-09-24 | #2499
- rf:bug-risks | medium | scripts/backlog/backlog-drive.ts:118 | 2026-09-24 | #2499
- rf:bug-risks | medium | .claude/skills/workflow-commands/backlogrun-steps.md:358 | 2026-09-24 | #2499
- rf:project-conventions | low | scripts/backlog/backlog-drive.ts:21 | 2026-09-24 | #2499
- rf:bug-risks | low | scripts/backlog/backlog-drive-cli.ts:225 | 2026-09-24 | #2499
- rf:tests | low | scripts/backlog/backlog-drive-cli.ts:217 | 2026-09-24 | #2499
- rf:bug-risks | medium | scripts/git/main-sync.ts | 2026-09-24 | #2504
- rf:project-conventions | low | scripts/git/gone-branch.ts | 2026-09-24 | #2504
- rf:tests | low | scripts/git/main-sync.test.ts | 2026-09-24 | #2504
- rf:bug-risks | medium | scripts/backlog/backlog-drive.ts:99 | 2026-09-24 | #2499
- rf:project-conventions | low | .claude/skills/workflow-commands/backlogrun-steps.md:357 | 2026-09-24 | #2499
- rf:bug-risks | low | scripts/run/run-cut.ts:255 | 2026-09-24 | #2515
- rf:none | none | - | 2026-09-24 | #2515
- rf:bug-risks | medium | scripts/git/stash-orphans.ts | 2026-09-24 | #2505
- rf:bug-risks | medium | scripts/run/run-carry-stash.ts | 2026-09-24 | #2505
- rf:bug-risks | low | scripts/git/stash-orphans.ts | 2026-09-24 | #2505
- rf:project-conventions | low | scripts/run/run-carry-stash.ts | 2026-09-24 | #2505
- rf:tests | low | scripts/run/run-carry-stash.test.ts | 2026-09-24 | #2505
...
- rf:tests | medium | scripts/ci/ci-yml-pnpm-setup.test.ts:21 | 2026-09-26 | #2194
- rf:comments | medium | docs/authentication.md:50 | 2026-09-26 | #2194
- rf:bug-risks | medium | templates/workflows/ci.yml:120 | 2026-09-26 | #2194
- rf:tests | medium | scripts/sync/publish-workflow.test.ts:68 | 2026-09-26 | #2194
- rf:comments | low | docs/troubleshooting.md:24 | 2026-09-26 | #2194
- rf:bug-risks | medium | .github/workflows/publish.yml:48 | 2026-09-26 | #2194
- rf:bug-risks | medium | docs/package.md:55 | 2026-09-26 | #2194
- rf:tests | medium | scripts/sync/publish-workflow.test.ts:67 | 2026-09-26 | #2194
- rf:tests | medium | scripts/sync/publish-workflow.test.ts:54 | 2026-09-26 | #2194
