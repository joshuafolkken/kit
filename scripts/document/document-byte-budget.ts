...
// joshuafolkken/kit#2180 raised it one slack unit (107,136 → 107,648) for the mandated `josh
// refactor:scan` section — the refactoring-candidate scan, its command reference and its `verdict:
// clear` / `verdict: candidates` answer — landing against a document already at its mark, the branch's
// merge with `main` layering the section on top.
...
const DOCUMENT_BYTE_BUDGET: ReadonlyArray<DocumentBudget> = [
	...
	{ path: 'docs/josh-commands.md', bytes: 106_818 },
