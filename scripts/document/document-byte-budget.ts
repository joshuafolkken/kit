...
const DOCUMENT_BYTE_BUDGET: ReadonlyArray<DocumentBudget> = [
	...
	{ path: '.claude/skills/workflow-commands/backlogrun.md', bytes: 55_566 },
	{ path: '.claude/skills/workflow-commands/chain-rule.md', bytes: 18_031 },
	{ path: '.claude/skills/workflow-commands/epicrun.md', bytes: 105_239 },
	...
	{ path: '.claude/skills/workflow-commands/fullrun.md', bytes: 13_751 },
	...
	{ path: '.claude/skills/workflow-commands/queue.md', bytes: 24_274 },
	...
	{ path: 'docs/josh-commands.md', bytes: 79_447 },
