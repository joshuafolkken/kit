...
import {
	MARKDOWN_EXTENSION,
	markdown_files_under,
} from '#scripts/document/shipped-documents-fixture'
...
// for. The two were kept independent on purpose (`scripts/gh/gh-subcommand-guard.ts` says so from its
