...
# 使用方法: ./scripts/lib/caddy-logs.sh
# chmod +x scripts/lib/caddy-logs.sh
#
# scp scripts/lib/caddy-logs.sh deploy-joshuastudio:/var/www/talk-svelte/scripts/ && \
# ssh deploy-joshuastudio "chmod +x /var/www/talk-svelte/scripts/lib/caddy-logs.sh && echo '✅ File uploaded and permissions set'"
