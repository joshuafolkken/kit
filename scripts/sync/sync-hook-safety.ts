...
function outdated_install_warning(
	writing_version: string,
	installed_version: string,
	filename: string,
): string {
	return (
		`  ⚠ skipped   ${filename} — installed ${KIT_PACKAGE_NAME} is ${installed_version}, ` +
...
function hook_write_warning(
	...
	return outdated_install_warning(writing_version, installed_version, filename)
}
